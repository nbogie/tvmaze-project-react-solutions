...
This is a solution _in React_ to level 100 of the tv-show-dom-project challenge.

This first level is intentionally written _without_ the use of common React idioms,
in order to be as familiar as possible for CYF students meeting React for the first time.
...
- All episodes assumed to have image links. (Correct for G.o.T. data (i.e. up to level 350)).
